...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/genji/Desktop/ros_stuff/tutorials/catkin_ws/install/${idir}'.  Ask the maintainer 'genji <genji.noguchi@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/genji/Desktop/ros_stuff/tutorials/catkin_ws/install/lib;/home/genji/Desktop/ros_stuff/tutorials/catkin_ws/devel/lib;/opt/ros/jade/lib)
